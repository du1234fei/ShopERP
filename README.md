...
#### 【自己二次开发私有仓，学习用途，自己摸索升级中，方便记录、项目只保留了原始的后端 ERP 功能】

#### 💐 核心商城（ShopERP）介绍     

> 核心商城系统`（ShopERP）` 是基于 Asp.Net 8.0 开发、支持可视化布局的小程序商城系统；前后端分离，支持跨平台运行；拥有分销、代理、团购秒杀、接龙、拼团、直播、优惠券、自定义表单等众多营销功能，拥有完整SKU、下单、售后、物流流程，支持可视化自定义首页模块布局效果。    
